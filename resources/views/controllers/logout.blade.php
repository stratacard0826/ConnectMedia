        ...
        <section id="logout" class="border panel panel-default">
            <header class="font2 panel-heading clearfix">
                ...
                <div class="fright">
                    ...
                    <a class="fleft colorfff font2 btn-sm btn-primary" ng-click="open('/logouts/report')" ng-show="hasPermission('logouts.report')">
                        View Report
                    ...
                    <a class="fright colorfff font2 btn-sm btn-primary" ng-click="open('/logouts/add')" ng-show="hasPermission('logouts.create')">
                        Add logout
                        <i class="fa fa-arrow-circle-o-right"></i>
                    </a>
                ...
                <table class="table table-bordered table-striped list">
                    ...
                    <tbody>
                        ...
                        <tr dir-paginate="logout in page.data | itemsPerPage:page.showing" total-items="page.total" current-page="page.current">
                            ...
                            <td>@{{ logout.creator.firstname }} @{{ logout.creator.lastname }}</th>
                            <td> @{{ logout.date | date:'fullDate' }}</td>
                            <td>@{{ logout.store.name }}</td>
                            <td class="text-center actions">
                                <a class="btn-sm btn-default" ng-click="open('/logouts/view/' + logout.id )" ng-show="hasPermission('logouts.view')">View</a>
                                <a class="btn-sm btn-primary" ng-click="open('/logouts/edit/' + logout.id )" ng-show="hasPermission('logouts.edit')">Edit</a>
                                <a class="btn-sm btn-danger" ng-click="delete( logout )" ng-show="hasPermission('logouts.delete')">Delete</a>
                            </td>
                        </tr>

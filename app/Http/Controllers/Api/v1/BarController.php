...
class BarController extends Controller {
    ...
    **/
    public function getAllRecipes( $limit = 15 , $page = 1 ){
        ...
        $query  = Recipe::where('link_type','bar');
        ...
        if( $validator->fails() ){
            ...
            try {
                ...
                $recipe->notifications()->create(array(
                    ...
                    'type'      => 'New Menu item',
                    'details'   => $data['name'],
                    'url'       => '/bar/view/' . $recipe->id

                ))->send([

                    'permissions' => [ Permission::where('slug' , 'bar.view' )->first()->id ]
    ...
    public function deleteRecipe( $recipeid ){  
        ...
        if( $recipe = Recipe::find( $recipeid ) ){
            ...
            $recipe->notifications()->create([
                ...
                'permissions' => [ Permission::where('slug' , 'bar.delete' )->first()->id ],
